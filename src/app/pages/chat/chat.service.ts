...
let talks = [
    new Chat(
        ...
        'Ashley Ahlberg', 
        'Online',
        'Hi, I\'m looking for admin template with angular material 2 design.  What do you think about Dare Admin Template?',
    ...
    new Chat(
        ...
        'Emilio Verdines', 
        'Online',
        'Hi, Dare is a fully compatible with angular material 2, responsive, organized folder structure, clean & customizable code, easy to use and much more...',
